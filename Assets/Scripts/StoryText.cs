...
public class StoryText : MonoBehaviour
{
    ...
    readonly List<List<string>> storyText = new() {
        ...
        new() {
            ...
            "Now let's get this ship moving. Left-click and drag the mouse to select a destination Lieutenant.",
            "Right-Click to lock it in. ",
            "Upgrade your ship speed and acceleration, maneuverability, and turning with supply points. Fire power and survivability can also be upgraded.",
            ...
            "Defeat all enemy ships to complete the level and gain supply points.",
            ...
            "Rank up to command new ships and allies as you face new enemies throughout the world",
